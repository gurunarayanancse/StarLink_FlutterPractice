...
import 'package:star_link/StarLink/Views/ProductVarientScreen/ProductVarientScreen.dart';
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
        ...
        itemBuilder: (context, index) => ProductCard(
              ...
              onPressed: () {
                if (widget.productList[index].isCustomizable ?? false) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
              ...
              isCustomizable: widget.productList[index].isCustomizable ?? false,
            ));
  }
}
