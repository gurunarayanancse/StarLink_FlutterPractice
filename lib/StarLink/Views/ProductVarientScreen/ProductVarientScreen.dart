...
import 'package:star_link/StarLink//Models/Product.dart';
...
import 'package:star_link/customWidgets/StarLinkButtonWithTrippleArrow.dart';
  ...
  Widget getPriceView() {
    return Row(
      children: [
        ...
        StarLinkTextLabel(
          text: widget.productInfo.price ?? "0.0",
          size: 27,
